...
/* Linux */
#if (defined(__linux) || defined(__linux__) || defined(linux)) && !defined(DUK_F_GENERIC)
#define DUK_F_LINUX
#endif
...
/* POSIX */
#if defined(__posix) && !defined(DUK_F_GENERIC)
#define DUK_F_POSIX
#endif
...
/* Generic Unix (includes Cygwin) */
    ...
    defined(DUK_F_LINUX) || defined(DUK_F_BSD)) && !defined(DUK_F_GENERIC)
#define DUK_F_UNIX
#endif
...
/* Shared includes: Freestanding ArchaOS */
#include "js_shim.h"
#include <stdarg.h>
#include <stddef.h>
#include <limits.h>
