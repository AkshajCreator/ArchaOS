...
png_cancelled = "/home/akushaji/.gemini/antigravity/brain/76c8cde7-d985-4437-a945-3df60eb8d22d/images/browser_cancelled.png"
...
# Immediately hit Escape to cancel loading!
time.sleep(0.1)
send_monitor("sendkey esc")
time.sleep(1.0)

send_monitor("screendump /tmp/archaos_test/cancelled.ppm")
time.sleep(0.5)
subprocess.run(["pnmtopng", "/tmp/archaos_test/cancelled.ppm"], stdout=open(png_cancelled, "wb"))
