...
png_ddg_lite = "/home/akushaji/.gemini/antigravity/brain/76c8cde7-d985-4437-a945-3df60eb8d22d/images/browser_ddg_lite.png"
...
# Initial mouse is at (160, 100).
# Window is at (20, 15). Bookmarks bar is at y=15+27=42. DDG is at x=20+120=140.
# dx = 140 - 160 = -20. dy = 42 - 100 = -58.
...
send_monitor("screendump /tmp/archaos_test/ddg_lite.ppm")
time.sleep(0.5)
subprocess.run(["pnmtopng", "/tmp/archaos_test/ddg_lite.ppm"], stdout=open(png_ddg_lite, "wb"))

proc.terminate()
print("Bookmark click test complete!")
