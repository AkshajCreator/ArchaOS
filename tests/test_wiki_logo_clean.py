...
SERIAL_LOG = "/tmp/archaos_test/wiki_clean.log"
...
try:
    ...
    # Click Wikipedia bookmark: (150, 58) from (160, 100) -> dx = -10, dy = -42
    ...
    # Click the [IMG] card at (30, 125) from (150, 58) -> dx = -120, dy = 67
    print("Clicking [IMG] card at (30, 125)...")
    send("mouse_move -120 67", 0.2)
    send("mouse_button 1", 0.1)
    send("mouse_button 0", 4.0)

    # Move mouse away to (280, 180) from (30, 125) -> dx = 250, dy = 55
    print("Moving mouse away to reveal full logo...")
    send("mouse_move 250 55", 0.5)

    cap("wiki_svg_logo_clean")
